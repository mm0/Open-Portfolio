...
attribute "nginx/hostname",
  :display_name => "Nginx site name ",
  :description => "Site name for nginx site",
  :default => ""

attribute "nginx/www_root",
  :display_name => "Nginx site doc root",
  :description => "Doc root for nginx site",
